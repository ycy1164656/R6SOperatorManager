...
- (void)createLayers:(UIImage *)image {
    ...
    CGRect lineFrame = CGRectInset(imageFrame, -8.0, -8.0);
    ...
    circleShape.fillColor = [CommonUtils randomColor].CGColor;
    ...
    for (NSInteger i = 0; i < 5; i++) {
        ...
        line.strokeColor = [CommonUtils randomColor].CGColor;
        line.lineWidth = 1.6;
        line.miterLimit = 1.6;
        line.path = ({
...
- (void)touchDown:(CollectButton *)sender {
    self.layer.opacity = 0.4;
}

- (void)touchUpInside:(CollectButton *)sender {
    self.layer.opacity = 1.0;
}

- (void)touchDragExit:(CollectButton *)sender {
    self.layer.opacity = 1.0;
}

- (void)touchDragEnter:(CollectButton *)sender {
    self.layer.opacity = 0.4;
}

- (void)touchCancel:(CollectButton *)sender {
    self.layer.opacity = 1.0;
}
